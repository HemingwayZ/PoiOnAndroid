...
//import org.apache.poi.xslf.usermodel.RenderingHints;
...
public class Graphics2D extends Graphics {
	 ...
	 * {@link BasicStroke#createStrokedShape}
	 * @param stroke
	 */
	...
	public AffineTransform getRenderingHint(RenderingHints groupTransform) {
		return affineTransformHintMap.get(groupTransform);
	}
	
	HashMap<RenderingHints, AffineTransform> affineTransformHintMap = new HashMap<RenderingHints, AffineTransform>();

	public void setRenderingHint(RenderingHints hint, boolean b) {
		if (hint == RenderingHints.GSAVE) {
			canvas.save();
		} else if (hint == RenderingHints.GRESTORE) {
			canvas.restore();
		}
	}

	public void setRenderingHint(RenderingHints groupTransform,
			AffineTransform tx0) {
