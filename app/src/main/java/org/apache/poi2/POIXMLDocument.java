...
import org.apache.poi2.poifs.common.POIFSConstants;
//import POIFSConstants;
import org.apache.poi2.util.IOUtils;

public abstract class POIXMLDocument extends org.apache.poi2.POIXMLDocumentPart {
...
//    }
    ...
    protected final void load(POIXMLFactory factory) throws IOException {
        Map<PackagePart, org.apache.poi2.POIXMLDocumentPart> context = new HashMap<PackagePart, POIXMLDocumentPart>();
        try {
