...
public final class PackageRelationship {
	 ...
	 */
	private org.apache.poi2.openxml4j.opc.OPCPackage container;
	 ...
	 */
	private org.apache.poi2.openxml4j.opc.TargetMode targetMode;
	 ...
	 * @param id
	 */
	public PackageRelationship(org.apache.poi2.openxml4j.opc.OPCPackage pkg, PackagePart sourcePart,
                               URI targetUri, org.apache.poi2.openxml4j.opc.TargetMode targetMode, String relationshipType,
                               String id) {
		if (pkg == null)
	...
	public URI getSourceURI() {
		if (source == null) {
			return org.apache.poi2.openxml4j.opc.PackagingURIHelper.PACKAGE_ROOT_URI;
		}
	 ...
	 */
	public org.apache.poi2.openxml4j.opc.TargetMode getTargetMode() {
		return targetMode;
	}
