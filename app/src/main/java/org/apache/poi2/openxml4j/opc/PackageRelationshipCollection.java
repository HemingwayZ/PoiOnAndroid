...
public final class PackageRelationshipCollection implements
	...
	private static PackagePartName getRelationshipPartName(PackagePart part)
		...
		if (part == null) {
			partName = org.apache.poi2.openxml4j.opc.PackagingURIHelper.PACKAGE_ROOT_PART_NAME;
		} else {
			partName = part.getPartName();
		}
		return org.apache.poi2.openxml4j.opc.PackagingURIHelper.getRelationshipPartName(partName);
	}
