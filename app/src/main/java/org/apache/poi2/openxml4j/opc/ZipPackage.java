...
import org.apache.poi2.openxml4j.opc.internal.FileHelper;
...
import org.apache.poi2.openxml4j.opc.internal.marshallers.ZipPartMarshaller;
import org.apache.poi2.openxml4j.util.ZipEntrySource;
...
import org.apache.poi2.openxml4j.util.ZipFileZipEntrySource;
import org.apache.poi2.openxml4j.util.ZipInputStreamZipEntrySource;
...
public final class ZipPackage extends Package {
	 ...
	 *             ZipInputStream.
	 */
	ZipPackage(InputStream in, org.apache.poi2.openxml4j.opc.PackageAccess access) throws IOException {
		super(access);
	 ...
	 */
	@Override
	protected PackagePart[] getPartsImpl() throws org.apache.poi2.openxml4j.exceptions.InvalidFormatException {
		...
		while (entries.hasMoreElements()) {
			...
			if (contentType != null && contentType.equals(ContentTypes.RELATIONSHIPS_PART)) {
				try {
					partList.put(partName, new org.apache.poi2.openxml4j.opc.ZipPackagePart(this, entry,
	...
	private PackagePartName buildPartName(ZipEntry entry) {
		try {
			...
			return org.apache.poi2.openxml4j.opc.PackagingURIHelper.createPartName(ZipHelper
			...
			for (PackagePart part : getParts()) {
				...
				if (marshaller != null) {
					if (!marshaller.marshall(part, zos)) {
						throw new org.apache.poi2.openxml4j.exceptions.OpenXML4JException(
								"The part "
