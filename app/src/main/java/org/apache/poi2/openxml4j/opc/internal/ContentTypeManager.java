...
public abstract class ContentTypeManager {
	 ...
	 *            delete.
	 * @exception org.apache.poi2.openxml4j.exceptions.InvalidOperationException
	 *                Throws if
	 */
	public void removeContentType(PackagePartName partName)
		...
		if (this.container != null) {
			try {
				for (org.apache.poi2.openxml4j.opc.PackagePart part : this.container.getParts()) {
				...
				throw new org.apache.poi2.openxml4j.exceptions.InvalidOperationException(e.getMessage());
			}
		}
	 ...
	 *         else <code>null</code>.
	 *
	 * @exception org.apache.poi2.openxml4j.exceptions.OpenXML4JRuntimeException
	...
	private void parseContentTypesFile(InputStream in)
		...
		try {
			...
			throw new org.apache.poi2.openxml4j.exceptions.InvalidFormatException(urie.getMessage());
