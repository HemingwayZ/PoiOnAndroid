...
package org.apache.poi2.openxml4j.opc.internal.marshallers;
...
import org.apache.poi2.openxml4j.opc.PackageNamespaces;
import org.apache.poi2.openxml4j.opc.PackagePart;
import org.apache.poi2.openxml4j.opc.PackageRelationship;
import org.apache.poi2.openxml4j.opc.PackagingURIHelper;
import org.apache.poi2.openxml4j.opc.StreamHelper;
import org.apache.poi2.openxml4j.opc.TargetMode;
import org.apache.poi2.openxml4j.opc.internal.PartMarshaller;
import org.apache.poi2.openxml4j.opc.internal.ZipHelper;
...
import org.apache.poi2.openxml4j.opc.PackageRelationshipCollection;
...
public final class ZipPartMarshaller implements PartMarshaller {
	...
	public boolean marshall(PackagePart part, OutputStream os)
		...
		ZipEntry partEntry = new ZipEntry(org.apache.poi2.openxml4j.opc.internal.ZipHelper
		...
		try {
			...
			byte[] buff = new byte[org.apache.poi2.openxml4j.opc.internal.ZipHelper.READ_WRITE_FILE_BUFFER_SIZE];
		...
		if (part.hasRelationships()) {
			PackagePartName relationshipPartName = org.apache.poi2.openxml4j.opc.PackagingURIHelper
	...
	public static boolean marshallRelationshipPart(
		...
		Element root = xmlOutDoc.addElement(new QName(
				org.apache.poi2.openxml4j.opc.PackageRelationship.RELATIONSHIPS_TAG_NAME, dfNs));
		...
		URI sourcePartURI = org.apache.poi2.openxml4j.opc.PackagingURIHelper
				.getSourcePartUriFromRelationshipPartUri(relPartName.getURI());

		for (org.apache.poi2.openxml4j.opc.PackageRelationship rel : rels) {
			// the relationship element
			Element relElem = root
					.addElement(org.apache.poi2.openxml4j.opc.PackageRelationship.RELATIONSHIP_TAG_NAME);

			// the relationship ID
			relElem.addAttribute(org.apache.poi2.openxml4j.opc.PackageRelationship.ID_ATTRIBUTE_NAME, rel
					.getId());

			// the relationship Type
			relElem.addAttribute(org.apache.poi2.openxml4j.opc.PackageRelationship.TYPE_ATTRIBUTE_NAME, rel
					.getRelationshipType());
			...
			if (rel.getTargetMode() == TargetMode.EXTERNAL) {
				...
				relElem.addAttribute(
						org.apache.poi2.openxml4j.opc.PackageRelationship.TARGET_MODE_ATTRIBUTE_NAME,
						"External");
			} else {
