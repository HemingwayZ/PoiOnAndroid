...
package org.apache.poi2.openxml4j.opc.internal.unmarshallers;
...
import org.apache.poi2.openxml4j.opc.ZipPackage;
...
public final class PackagePropertiesUnmarshaller implements PartUnmarshaller {
	...
	private final static Namespace namespaceDC = new Namespace("dc",
			org.apache.poi2.openxml4j.opc.PackageProperties.NAMESPACE_DC);

	private final static Namespace namespaceCP = new Namespace("cp",
			org.apache.poi2.openxml4j.opc.PackageNamespaces.CORE_PROPERTIES);

	private final static Namespace namespaceDcTerms = new Namespace("dcterms",
			org.apache.poi2.openxml4j.opc.PackageProperties.NAMESPACE_DCTERMS);
	...
	public PackagePart unmarshall(UnmarshallContext context, InputStream in)
			throws org.apache.poi2.openxml4j.exceptions.InvalidFormatException, IOException {
		...
		if (in == null) {
			if (context.getZipEntry() != null) {
				in = ((org.apache.poi2.openxml4j.opc.ZipPackage) context.getPackage()).getZipArchive()
				...
				ZipEntry zipEntry = ZipHelper
						.getCorePropertiesZipEntry((org.apache.poi2.openxml4j.opc.ZipPackage) context
								.getPackage());
	...
	public void checkElementForOPCCompliance(Element el)
		...
		if (el.getNamespace().getURI().equals(
			...
			if (!(elName.equals(KEYWORD_CREATED) || elName
					.equals(KEYWORD_MODIFIED)))
				throw new org.apache.poi2.openxml4j.exceptions.InvalidFormatException("Namespace error : " + elName
			...
			if (typeAtt == null)
				throw new org.apache.poi2.openxml4j.exceptions.InvalidFormatException("The element '" + elName
