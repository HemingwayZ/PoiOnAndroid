...
public class POILogFactory
{
     ...
     */
    private static Map<String, org.apache.poi2.util.POILogger> _loggers = new HashMap<String, org.apache.poi2.util.POILogger>();;

    /**
     * A common instance of NullLogger, as it does nothing
     *  we only need the one
     */
    private static org.apache.poi2.util.POILogger _nullLogger = new NullLogger();
    /**
    ...
    public static org.apache.poi2.util.POILogger getLogger(final Class theclass)
    {
    ...
    public static org.apache.poi2.util.POILogger getLogger(final String cat)
    {
        org.apache.poi2.util.POILogger logger = null;
        ...
        if(_loggerClassName == null) {
        	try {
//        		_loggerClassName = System.getProperty("POILogger");
        ...
        if (_loggers.containsKey(cat)) {
            ...
            try {
              Class<? extends org.apache.poi2.util.POILogger> loggerClass =
