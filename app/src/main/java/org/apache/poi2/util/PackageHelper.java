...
public final class PackageHelper {
    ...
    public static OPCPackage clone(OPCPackage pkg, File file) throws OpenXML4JException, IOException {
        ...
        org.apache.poi2.openxml4j.opc.PackageRelationshipCollection rels = pkg.getRelationships();
        for (org.apache.poi2.openxml4j.opc.PackageRelationship rel : rels) {
            org.apache.poi2.openxml4j.opc.PackagePart part = pkg.getPart(rel);
            org.apache.poi2.openxml4j.opc.PackagePart part_tgt;
            if (rel.getRelationshipType().equals(org.apache.poi2.openxml4j.opc.PackageRelationshipTypes.CORE_PROPERTIES)) {
            ...
            org.apache.poi2.util.IOUtils.copy(part.getInputStream(), out);
            out.close();
     ...
     */
    private static void copy(OPCPackage pkg, org.apache.poi2.openxml4j.opc.PackagePart part, OPCPackage tgt, org.apache.poi2.openxml4j.opc.PackagePart part_tgt) throws OpenXML4JException, IOException {
        PackageRelationshipCollection rels = part.getRelationships();
        if(rels != null) for (org.apache.poi2.openxml4j.opc.PackageRelationship rel : rels) {
            org.apache.poi2.openxml4j.opc.PackagePart p;
            if(rel.getTargetMode() == org.apache.poi2.openxml4j.opc.TargetMode.EXTERNAL){
            ...
            org.apache.poi2.openxml4j.opc.PackagePartName relName = org.apache.poi2.openxml4j.opc.PackagingURIHelper.createPartName(rel.getTargetURI());
            ...
            org.apache.poi2.openxml4j.opc.PackagePart dest;
     ...
     */
    private static void copyProperties(org.apache.poi2.openxml4j.opc.PackageProperties src, org.apache.poi2.openxml4j.opc.PackageProperties tgt){
