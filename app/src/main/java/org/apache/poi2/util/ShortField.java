...
import org.apache.poi2.util.LittleEndian.BufferUnderrunException;
    ...
    implements FixedField
{
    ...
    public void readFromBytes(final byte [] data)
        throws ArrayIndexOutOfBoundsException
    {
        _value = org.apache.poi2.util.LittleEndian.getShort(data, _offset);
    }
    ...
    {
        _value = org.apache.poi2.util.LittleEndian.readShort(stream);
    }
