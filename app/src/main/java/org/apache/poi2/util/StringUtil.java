...
public class StringUtil {
	...
	public static String readCompressedUnicode(org.apache.poi2.util.LittleEndianInput in, int nChars) {
	 ...
	 */
	public static String readUnicodeString(org.apache.poi2.util.LittleEndianInput in) {
	 ...
	 * #readUnicodeString(org.apache.poi2.util.LittleEndianInput)} can be used.
	 */
	public static String readUnicodeString(org.apache.poi2.util.LittleEndianInput in, int nChars) {
	 ...
	 * For this encoding, the is16BitFlag is always present even if nChars==0.
	 */
	public static void writeUnicodeString(org.apache.poi2.util.LittleEndianOutput out, String value) {
	 ...
	 * This method should be used when the nChars field is <em>not</em> stored
	 * as a ushort immediately before the is16BitFlag. Otherwise, {@link
	 * #writeUnicodeString(org.apache.poi2.util.LittleEndianOutput, String)} can be used.
	 */
	public static void writeUnicodeStringFlagAndData(org.apache.poi2.util.LittleEndianOutput out, String value) {
		boolean is16Bit = hasMultibyte(value);
		out.writeByte(is16Bit ? 0x01 : 0x00);
		if (is16Bit) {
			putUnicodeLE(value, out);
	...
	/**
	 * @return the number of bytes that would be written by {@link #writeUnicodeString(org.apache.poi2.util.LittleEndianOutput, String)}
	 */
	...
	public static void putCompressedUnicode(String input, org.apache.poi2.util.LittleEndianOutput out) {
		byte[] bytes;
		try {
			bytes = input.getBytes(ENCODING_ISO_8859_1);
		} catch (UnsupportedEncodingException e) {
