...
import org.apache.poi2.xslf.model.PropertyFetcher;
import org.apache.poi2.xslf.model.geom.Context;
import org.apache.poi2.xslf.model.geom.CustomGeometry;
import org.apache.poi2.xslf.model.geom.Guide;
import org.apache.poi2.xslf.model.geom.IAdjustableShape;
import org.apache.poi2.xslf.model.geom.Outline;
import org.apache.poi2.xslf.model.geom.Path;
...
class RenderableShape {
     ...
     */
    public Paint selectPaint(Graphics2D graphics, XmlObject obj, CTSchemeColor phClr, org.apache.poi2.openxml4j.opc.PackagePart parentPart) {
...
//                    colors[0], pCenter, colors[colors.length - 1]);
    ...
    private Collection<Outline> computeOutlines(Graphics2D graphics) {
        ...
        for (Path p : geom) {
            ...
            double w = p.getW() == -1 ? anchor.getWidth() * org.apache.poi2.util.Units.EMU_PER_POINT : p.getW();
            double h = p.getH() == -1 ? anchor.getHeight() * org.apache.poi2.util.Units.EMU_PER_POINT : p.getH();
            ...
            if (p.getW() != -1) {
                ...
                scaleX = 1.0 / org.apache.poi2.util.Units.EMU_PER_POINT;
            }
            if (p.getH() != -1) {
