...
import org.apache.poi2.xslf.XSLFSlideShow;
import org.apache.poi2.POIXMLDocument;
...
import org.apache.poi2.util.IOUtils;
import org.apache.poi2.util.Internal;
import org.apache.poi2.util.PackageHelper;
...
//    private XSLFTableStyles _tableStyles;
    ...
    public XMLSlideShow(org.apache.poi2.openxml4j.opc.OPCPackage pkg) {
        super(pkg);
    ...
    static final org.apache.poi2.openxml4j.opc.OPCPackage empty() {
    ...
    @Deprecated
    public XSLFSlideShow _getXSLFSlideShow() throws org.apache.poi2.openxml4j.exceptions.OpenXML4JException, IOException, XmlException{
...
//                    _tableStyles = (XSLFTableStyles)p;
    ...
    protected void commit() throws IOException {
        ...
        org.apache.poi2.openxml4j.opc.PackagePart part = getPackagePart();
     ...
     */
    public List<org.apache.poi2.openxml4j.opc.PackagePart> getAllEmbedds() throws OpenXML4JException {
     ...
     * @return a {@link List} of {@link org.apache.poi2.openxml4j.opc.PackagePart}.
     * The returned {@link List} is unmodifiable. 
     */
    public List<XSLFPictureData> getAllPictures() {
        if(_pictures == null){
            List<org.apache.poi2.openxml4j.opc.PackagePart> mediaParts = getPackage().getPartsByName(Pattern.compile("/ppt/media/.*?"));
...
//        XSLFSlideLayout layout = master.getLayout(SlideLayout.BLANK);
    ...
    public Dimension getPageSize(){
        ...
        int cx = sz.getCx();
        int cy = sz.getCy();
        return new Dimension((int) org.apache.poi2.util.Units.toPoints(cx), (int) org.apache.poi2.util.Units.toPoints(cy));
    }
    ...
    public void setPageSize(Dimension pgSize){
        ...
        sz.setCx(org.apache.poi2.util.Units.toEMU(pgSize.getWidth()));
