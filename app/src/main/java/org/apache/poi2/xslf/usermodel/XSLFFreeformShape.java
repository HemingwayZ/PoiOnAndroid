...
import org.apache.poi2.util.Units;
...
public class XSLFFreeformShape extends XSLFAutoShape {
    ...
    public int setPath(GeneralPath path) {
        ...
        int x0 = org.apache.poi2.util.Units.toEMU(bounds.getX());
        int y0 = org.apache.poi2.util.Units.toEMU(bounds.getY());
        PathIterator it = path.getPathIterator(new AffineTransform());
        int numPoints = 0;
        ctPath.setH(org.apache.poi2.util.Units.toEMU(bounds.getHeight()));
        ctPath.setW(org.apache.poi2.util.Units.toEMU(bounds.getWidth()));
        while (!it.isDone()) {
            ...
            switch (type) {
                case PathIterator.SEG_MOVETO:
                    ...
                    mv.setX(org.apache.poi2.util.Units.toEMU(vals[0]) - x0);
                    mv.setY(org.apache.poi2.util.Units.toEMU(vals[1]) - y0);
                    numPoints++;
                    break;
                case PathIterator.SEG_LINETO:
                    CTAdjPoint2D ln = ctPath.addNewLnTo().addNewPt();
                    ln.setX(org.apache.poi2.util.Units.toEMU(vals[0]) - x0);
                    ln.setY(org.apache.poi2.util.Units.toEMU(vals[1]) - y0);
                    numPoints++;
                    break;
                case PathIterator.SEG_CUBICTO:
                    CTPath2DCubicBezierTo bez = ctPath.addNewCubicBezTo();
                    CTAdjPoint2D p1 = bez.addNewPt();
                    p1.setX(org.apache.poi2.util.Units.toEMU(vals[0]) - x0);
                    p1.setY(org.apache.poi2.util.Units.toEMU(vals[1]) - y0);
                    CTAdjPoint2D p2 = bez.addNewPt();
                    p2.setX(org.apache.poi2.util.Units.toEMU(vals[2]) - x0);
                    p2.setY(org.apache.poi2.util.Units.toEMU(vals[3]) - y0);
                    CTAdjPoint2D p3 = bez.addNewPt();
                    p3.setX(org.apache.poi2.util.Units.toEMU(vals[4]) - x0);
                    p3.setY(org.apache.poi2.util.Units.toEMU(vals[5]) - y0);
                    numPoints += 3;
                    break;
    ...
    public GeneralPath getPath() {
        ...
        for(CTPath2D spPath : geom.getPathLst().getPathList()){
            double scaleW = bounds.getWidth() / org.apache.poi2.util.Units.toPoints(spPath.getW());
            double scaleH = bounds.getHeight() / org.apache.poi2.util.Units.toPoints(spPath.getH());
            for(XmlObject ch : spPath.selectPath("*")){
                if(ch instanceof CTPath2DMoveTo){
                    CTAdjPoint2D pt = ((CTPath2DMoveTo)ch).getPt();
                    path.moveTo(
                            (float) (org.apache.poi2.util.Units.toPoints((Long) pt.getX()) * scaleW),
                            (float) (org.apache.poi2.util.Units.toPoints((Long) pt.getY()) * scaleH));
                } else if (ch instanceof CTPath2DLineTo){
                    CTAdjPoint2D pt = ((CTPath2DLineTo)ch).getPt();
                    path.lineTo((float) org.apache.poi2.util.Units.toPoints((Long)pt.getX()),
                                (float) org.apache.poi2.util.Units.toPoints((Long)pt.getY()));
                    ...
                    path.curveTo(
                            (float) (org.apache.poi2.util.Units.toPoints((Long) pt1.getX()) * scaleW),
                            (float) (org.apache.poi2.util.Units.toPoints((Long) pt1.getY()) * scaleH),
                            (float) (org.apache.poi2.util.Units.toPoints((Long) pt2.getX()) * scaleW),
                            (float) (org.apache.poi2.util.Units.toPoints((Long) pt2.getY()) * scaleH),
                            (float) (org.apache.poi2.util.Units.toPoints((Long) pt3.getX()) * scaleW),
