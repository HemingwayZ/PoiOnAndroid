...
public class XSLFGroupShape extends XSLFShape implements XSLFShapeContainer {
    ...
    public Rectangle2D getAnchor(){
        ...
        return new Rectangle2D.Double(
                org.apache.poi2.util.Units.toPoints(x), org.apache.poi2.util.Units.toPoints(y),
                org.apache.poi2.util.Units.toPoints(cx), org.apache.poi2.util.Units.toPoints(cy));
    }
    ...
    public void setAnchor(Rectangle2D anchor){
        ...
        long x = org.apache.poi2.util.Units.toEMU(anchor.getX());
        long y = org.apache.poi2.util.Units.toEMU(anchor.getY());
        off.setX(x);
        off.setY(y);
        CTPositiveSize2D ext = xfrm.isSetExt() ? xfrm.getExt() : xfrm.addNewExt();
        long cx = org.apache.poi2.util.Units.toEMU(anchor.getWidth());
        long cy = org.apache.poi2.util.Units.toEMU(anchor.getHeight());
        ext.setCx(cx);
        ext.setCy(cy);
    }
    ...
    public XSLFPictureShape createPicture(int pictureIndex){
        ...
        List<org.apache.poi2.openxml4j.opc.PackagePart>  pics = _sheet.getPackagePart().getPackage()
