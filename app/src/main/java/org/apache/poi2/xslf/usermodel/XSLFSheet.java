...
@Beta
public abstract class XSLFSheet extends org.apache.poi2.POIXMLDocumentPart implements XSLFShapeContainer {
    ...
    public XSLFSheet(org.apache.poi2.openxml4j.opc.PackagePart part, org.apache.poi2.openxml4j.opc.PackageRelationship rel){
        super(part, rel);
    }
    ...
    public XSLFPictureShape createPicture(int pictureIndex){
        List<org.apache.poi2.openxml4j.opc.PackagePart>  pics = getPackagePart().getPackage()
        ...
        org.apache.poi2.openxml4j.opc.PackagePart pic = pics.get(0);

        org.apache.poi2.openxml4j.opc.PackageRelationship rel = getPackagePart().addRelationship(
                pic.getPartName(), org.apache.poi2.openxml4j.opc.TargetMode.INTERNAL, XSLFRelation.IMAGES.getRelation());
   ...
   /**
     ...
     */
    String importBlip(String blipId, org.apache.poi2.openxml4j.opc.PackagePart packagePart) {
        org.apache.poi2.openxml4j.opc.PackageRelationship blipRel = packagePart.getRelationship(blipId);
        org.apache.poi2.openxml4j.opc.PackagePart blipPart;
        try {
