...
import org.apache.poi2.xslf.model.ParagraphPropertyFetcher;
...
//    private TextFragment _bullet;
    ...
    public void setIndent(double value){
        ...
        if(value == -1) {
            ...
            pr.setIndent(org.apache.poi2.util.Units.toEMU(value));
        }
    }
        ...
        ParagraphPropertyFetcher<Double> fetcher = new ParagraphPropertyFetcher<Double>(getLevel()){
            public boolean fetch(CTTextParagraphProperties props){
                if(props.isSetIndent()){
                    setValue(org.apache.poi2.util.Units.toPoints(props.getIndent()));
                    return true;
                }
                return false;
            }
    ...
    public void setLeftMargin(double value){
        ...
        if(value == -1) {
            ...
            pr.setMarL(org.apache.poi2.util.Units.toEMU(value));
        }
    ...
    public double getLeftMargin(){
        ParagraphPropertyFetcher<Double> fetcher = new ParagraphPropertyFetcher<Double>(getLevel()){
            public boolean fetch(CTTextParagraphProperties props){
                if(props.isSetMarL()){
                    double val = org.apache.poi2.util.Units.toPoints(props.getMarL());
                    setValue(val);
                    return true;
                }
                return false;
        ...
        ParagraphPropertyFetcher<Double> fetcher = new ParagraphPropertyFetcher<Double>(getLevel()){
            public boolean fetch(CTTextParagraphProperties props){
                if(props.isSetDefTabSz()){
                    double val = org.apache.poi2.util.Units.toPoints(props.getDefTabSz());
                    setValue(val);
                    return true;
                }
                return false;
